    ...
    <div className="space-y-5 p-4 sm:p-6">
      ...
      {hasResults && (
        <div className="flex items-start gap-2 rounded-xl border border-amber-200 bg-amber-50 px-4 py-2.5 text-xs text-amber-700">
          ...
          <span>
            <strong>Coverage Note:</strong> No hardware sweeping sensor signal available. "Actual Swept KM" is calculated by measuring how much of each planned road's GPS route was traversed by the vehicle. Tolerance: 30m. GPS points are deduplicated and noise-filtered. Ignition ON does <em>not</em> confirm sweeping.
          </span>
        </div>
      )}
